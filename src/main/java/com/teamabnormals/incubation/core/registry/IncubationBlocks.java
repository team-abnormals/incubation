...
public class IncubationBlocks {
	...
	public static final RegistryObject<Block> TWIG_NEST = HELPER.createBlock("twig_nest", () -> new EmptyNestBlock(IncubationProperties.TWIG_NEST));
	...
	public static final RegistryObject<Block> HAY_NEST = HELPER.createBlock("hay_nest", () -> new EmptyNestBlock(IncubationProperties.HAY_NEST));
