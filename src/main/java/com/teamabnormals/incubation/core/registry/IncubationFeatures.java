...
public class IncubationFeatures {
	...
	public static final class IncubationConfiguredFeatures {
		public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(Registries.CONFIGURED_FEATURE, Incubation.MOD_ID);
...
//		}
	...
	public static final class IncubationPlacedFeatures {
		public static final DeferredRegister<PlacedFeature> PLACED_FEATURES = DeferredRegister.create(Registries.PLACED_FEATURE, Incubation.MOD_ID);
