...
public class IncubationBlocks {
	...
	public static final RegistryObject<Block> TWIG_DUCK_NEST = HELPER.createBlockNoItem("twig_duck_nest", () -> new BirdNestBlock(new ResourceLocation("environmental", "duck_egg"), (EmptyNestBlock) TWIG_NEST.get(), IncubationProperties.TWIG_NEST));
	public static final RegistryObject<Block> TWIG_TURKEY_NEST = HELPER.createBlockNoItem("twig_turkey_nest", () -> new BirdNestBlock(new ResourceLocation("autumnity", "turkey_egg"), (EmptyNestBlock) TWIG_NEST.get(), IncubationProperties.TWIG_NEST));
	...
	public static final RegistryObject<Block> HAY_DUCK_NEST = HELPER.createBlockNoItem("hay_duck_nest", () -> new BirdNestBlock(new ResourceLocation("environmental", "duck_egg"), (EmptyNestBlock) HAY_NEST.get(), IncubationProperties.HAY_NEST));
	public static final RegistryObject<Block> HAY_TURKEY_NEST = HELPER.createBlockNoItem("hay_turkey_nest", () -> new BirdNestBlock(new ResourceLocation("autumnity", "turkey_egg"), (EmptyNestBlock) HAY_NEST.get(), IncubationProperties.HAY_NEST));
